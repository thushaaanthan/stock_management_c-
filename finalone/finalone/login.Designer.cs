...
namespace finalone.loginTableAdapters {
...
SELECT USERNAME, PASSWORD FROM LOGIN WHERE (USERNAME = @USERNAME)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::finalone.Properties.Settings.Default.DataConnectionString;
        }
        ...
        public virtual int Fill(login.LOGINDataTable dataTable) {
        ...
        public virtual login.LOGINDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            login.LOGINDataTable dataTable = new login.LOGINDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(login.LOGINDataTable dataTable) {
