...
namespace finalone
{
    public partial class changepassconw : Form
    {
        public changepassconw()
        {
            InitializeComponent();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                SqlConnection con3 = new SqlConnection(@"Data Source=(LocalDB)\v11.0;AttachDbFilename=C:\Users\TSA10\Documents\loginw.mdf;Integrated Security=True;Connect Timeout=30");
                con3.Open();
                string update = "update loginw set username=@name,password=@password,secquestion=@question where username=@id";
